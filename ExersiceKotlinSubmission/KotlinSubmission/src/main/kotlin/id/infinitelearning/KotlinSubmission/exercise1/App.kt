 ...
 *
 */
fun myName(groupMember: String): String {
    //var namaAnggota = "Agus,Annisa,Adity,Dela,Ikhlasul,Salman"
    return namaAnggota
}
...
fun totalMember(): Int {
    ...
    return countOfGroup + mentor.size
...
fun main() {
    ...
    val myName = myName("Rian")
    println("My Name is: $myName")

    val totalMember = totalMember()
    println("Total Member group + Mentor: $totalMember")

    println(myName("Agus,Annisa,Adity,Dela,Ikhlasul,Salman"))
    /**
     *  Latihan 5
     *  Ubah nilai argumen-argumen dari fungsi groupDetail di bawah ini sesuai dengan data group kamu
     *
     */
    groupDetail(1, listOf("Agus", "Annisa", "Aditya","Dela","Iklasul","Salman"), "Morning")
